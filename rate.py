...
driver.find_element_by_css_selector('#emailId').send_keys("mail123@gmail.com") #replace with your gmail generator /temp mail select these line and press ctrl+h symbol in keyboard it ask replace then replace emails in below code otp must not enter manually you must enter it 10 second delayed for that if want more change no
